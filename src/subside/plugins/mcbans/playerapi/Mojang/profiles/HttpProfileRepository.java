...
import subside.plugins.mcbans.playerapi.Mojang.http.BasicHttpClient;
import subside.plugins.mcbans.playerapi.Mojang.http.HttpBody;
import subside.plugins.mcbans.playerapi.Mojang.http.HttpClient;
import subside.plugins.mcbans.playerapi.Mojang.http.HttpHeader;
...
public class HttpProfileRepository implements ProfileRepository {
    ...
    public Profile[] findProfilesByNames(ArrayList<String> names) {
        List<Profile> profiles = new ArrayList<Profile>();
        try {
    ...
    private static HttpBody getHttpBody(List<String> namesBatch) {
        return new HttpBody(gson.toJson(namesBatch.toArray(new String[namesBatch.size()])));
    }
}
